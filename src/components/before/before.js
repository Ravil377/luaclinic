...
const swiperBefore = '.before-services__swiper';
const slides = document.querySelectorAll('.before-services__item');
let beforeSwiper;
const btns = document.querySelectorAll('.before-services__btn');
...
if (document.querySelector(swiperBefore)) {
  beforeSwiper = new Swiper(swiperBefore, {
      slidesPerView: 'auto',
      // freeMode: true,
      // loop: true,
      spaceBetween: 10,
...
slides.forEach(slide => {
  slide.addEventListener('click', () => beforeSwiper.enable());
})
