...
if (document.querySelector(swiperBefore)) {
  var beforeSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperBefore, {
    slidesPerView: 'auto',
    spaceBetween: 10,
    loop: true,
    breakpoints: {
    ...
    t.exports = function (t, e) {
      ...
      if (n = t.global ? r : t.stat ? r[l] || c(l, {}) : (r[l] || {}).prototype) for (a in e) {
        if (s = n[a], f = e[a], !t.forced && void 0 !== s) {
          if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(f) == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(s)) continue;
          u(f, s);
        }
